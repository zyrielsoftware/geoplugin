...
if(!class_exists('WP_CCSVE_Settings'))
{
	class WP_CCSVE_Settings
	{
		...
		{
			// register actions
            add_action('admin_init', array($this, 'wca_admin_init'));
         ...
         */
        public function wca_admin_init()
        {
            register_setting('wca-ccsve-group', 'ccsve_post_type');
            register_setting('wca-ccsve-group', 'ccsve_std_fields');
            register_setting('wca-ccsve-group', 'ccsve_tax_terms');
            register_setting('wca-ccsve-group', 'ccsve_custom_fields');

            add_settings_section(
                'wca_ccsve_template-section', 
                'WCA CSV Exporter Settings', 
                array(&$this, 'settings_section_wca_ccsve_template'), 
                'wca_ccsve_template'
            );
        ...
        public function settings_section_wca_ccsve_template()
        {
            
            //echo 'These are the settings for the WCA CSV Export Plugin.';
        }
